...
export function sendMessageToMain(prefix: string, type: string, data: any): void {
...
export async function getBinaryFile(url: string): Promise<ArrayBuffer> {
